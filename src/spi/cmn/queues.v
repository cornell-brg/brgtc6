...
`include "spi/cmn/regs.v"
`include "spi/cmn/muxes.v"
`include "spi/cmn/regfiles.v"
`include "spi/cmn/assert.v"
...
module cmn_QueueDpath1 #(
  ...
  generate
    if (|(p_type & `CMN_QUEUE_BYPASS))
      ...
      logic unused;
      assign unused = &{1'b0, bypass_mux_sel, 1'b0};
...
module cmn_QueueDpath #(
  ...
  generate
    if (|(p_type & `CMN_QUEUE_BYPASS))
      ...
      logic unused;
      assign unused = 1'b0 & bypass_mux_sel;
