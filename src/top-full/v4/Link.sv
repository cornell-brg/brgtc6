`ifndef BRGTC6_LINK_V4
`define BRGTC6_LINK_V4

`define CHNL_MSG 1'b0
`define CNFG_MSG 1'b1

`include "top-full/v4/Upstream.sv"
`include "top-full/v4/Downstream.sv"
`include "config/ConfigIfcV4.sv"
...
module Link #(
    ...
    output logic                        up_cred_crc,
    output logic                        up_cred_repair,
    ...
    input  logic                        down_cred_crc,
    input  logic                        down_cred_repair
);
...
//=========================================================================
    ...
    logic [2:0]                 cfg_dbg_tick_cnt;
    logic                       cfg_go;
    logic [p_clk_width-1:0]     cfg_clk_div_factor;
    logic [p_clk_width-1:0]     cfg_clk_div_skew;
    logic                       cfg_crc_error_bit;
    logic [p_channel_width-1:0] cfg_up_repair_sel;
    logic [p_channel_width-1:0] cfg_down_repair_sel;
    logic [$clog2(p_max_credit+1)-1:0] cfg_dbg_next_cred_cnt;
    logic [1:0]                 cfg_dbg_cred_rst_delay;
...
//=========================================================================
    ...
    Upstream #(
        ...
        .repair_sel    (cfg_up_repair_sel),
        .dbg_next_cred_cnt (cfg_dbg_next_cred_cnt),
        .dbg_cred_rst_delay (cfg_dbg_cred_rst_delay),
        ...
        .cred_crc      (up_cred_crc),
        .cred_repair   (up_cred_repair)
    );
...
//=========================================================================
    ...
    Downstream #(
        ...
        .repair_sel         (cfg_down_repair_sel),
        .crc_error_bit      (cfg_crc_error_bit),
        .dbg_tick_cnt     (cfg_dbg_tick_cnt),
        .cred_msg           (down_cred_msg),
        .cred_val           (down_cred_val),
        .cred_clk           (down_cred_clk),
        .cred_rst           (down_cred_rst),
        .cred_cred          (down_cred_cred),
        .cred_crc           (down_cred_crc),
        .cred_repair        (down_cred_repair)
    );
